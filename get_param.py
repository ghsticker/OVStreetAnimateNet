...
def params():
	...
	# Training parameters
	parser.add_argument('--net', default="UNet", type=str, help='network to train (default: UNet)', choices=["UNet"])
	parser.add_argument('--n_epochs', default=300, type=int, help='number of epochs (after each epoch, the model gets saved)')
	...
	parser.add_argument('--loss_rho', default=10, type=float, help='loss factor for keeping rhoxxxxx fixed')
	...
	parser.add_argument('--regularize_grad_p', default=1, type=float, help='regularizer for gradient of p. evt needed for very high reynolds numbers (default: 0)')
